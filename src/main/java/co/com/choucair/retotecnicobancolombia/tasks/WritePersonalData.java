...
public class WritePersonalData implements Task {
    ...
    public static WritePersonalData onStep1(String firstName, String lastName, String email, String month, String day, String year) {
        return Tasks.instrumented(WritePersonalData.class,firstName,lastName,email,month,day,year);
    }
...
//            Click.on(UtestSingupPersonalPage.BUTTON_NEXT_SPET)
                ...
                Enter.theValue(firstName).into(UtestSingupPersonalPage.INPUT_FIRSTNAME),
                Enter.theValue(lastName).into(UtestSingupPersonalPage.INPUT_LASTNAME),
                Enter.theValue(email).into(UtestSingupPersonalPage.INPUT_EMAIL),
                SelectFromOptions.byVisibleText(month).from(UtestSingupPersonalPage.DAY_BIRTH_MONTH),
                SelectFromOptions.byVisibleText(day).from(UtestSingupPersonalPage.DAY_BIRTH_DAY),
                SelectFromOptions.byVisibleText(year).from(UtestSingupPersonalPage.DAY_BIRTH_YEAR),
                Click.on(UtestSingupPersonalPage.BUTTON_NEXT_SPET)
